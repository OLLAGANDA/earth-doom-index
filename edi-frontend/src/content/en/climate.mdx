...
**Heat-humidity stress** scores 0.5 when relative humidity exceeds 80% and the feels-like temperature is above 25°C — the combination that makes heat genuinely dangerous rather than merely unpleasant.
